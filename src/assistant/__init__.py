...
Execution authority restructure -- see docs/architecture/TRADE_ASSISTANT_ARCHITECTURE.md. It requires an
...
Three independent public runtime entry points (see docs/architecture/TRADE_ASSISTANT_ARCHITECTURE.md's
"Strategy vs. capability boundary"):
    ...
    runtime.evaluate(strategy_id, symbol, cycle, mode)  -- ASSISTANT_RUNTIME_V1
        ...
        docs/specs/FIVE_SKILL_ASSISTANT_RUNTIME_V1_SPEC.md's "Strategy independence" section. No
        execution authority.
