...
supersedes the other -- see docs/specs/FIVE_SKILL_ASSISTANT_RUNTIME_V1_SPEC.md's "Strategy
...
def analyze_market(request: AssistantAnalysisRequest) -> FiveSkillAnalysisResult:
    ...
    # (docs/specs/ENTRY_CONFIRMATION_V1_SPEC.md) -- requesting it resolves that dependency closure,
            ...
            if entry_confirmation.overall_state == OverallState.INDETERMINATE:
                ...
                if unsigned:
                    limitations.append(
                        ...
                        f"(measurement available, no owner-signed threshold) -- see docs/specs/ENTRY_CONFIRMATION_V1_SPEC.md."
                    )
    else:
