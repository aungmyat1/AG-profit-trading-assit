"""Asian reference range construction. FORK_COPY_FROZEN, byte-identical logic to
session_trading_source_v1/asian_range.py (ST_SESSION_TRADING_SOURCE_V1 v0.1.0).
