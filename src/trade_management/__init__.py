...
ownership (see docs/architecture/TRADE_ASSISTANT_ARCHITECTURE.md's "Assistant skill taxonomy").
...
2. Pre-trade calculation (Phase 5 continuation, `TRADE_MANAGEMENT_V1`, added
   ...
   See docs/specs/ENTRY_CONFIRMATION_V1_SPEC.md's sibling, docs/specs/TRADE_MANAGEMENT_V1_SPEC.md.
