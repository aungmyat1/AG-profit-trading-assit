...
see TRADE_ASSISTANT_ARCHITECTURE.md's "Strategy vs. capability boundary" and
FIVE_SKILL_ASSISTANT_RUNTIME_V1_SPEC.md.
...
# and TRADE_ASSISTANT_ARCHITECTURE.md's "Assistant skill taxonomy" verbatim.
...
class SupplyDemandBundle:
    ...
    FIVE_SKILL_ASSISTANT_RUNTIME_V1_SPEC.md's "Known limitations"."""
