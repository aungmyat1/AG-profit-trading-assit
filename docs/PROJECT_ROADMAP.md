...
Bind the existing Large-SMC research engine to V2 without changing its canonical semantics or `RESEARCH_ONLY` authority.

## V2-3B — SSC Shadow / Replay Adapter

Bind the canonical SSC evaluator/replay path to V2. Preserve exact strategy identity and prohibit substitution through another runtime strategy.

## Parity Checkpoint #1 — Large-SMC + SSC

Require canonical/V2 parity for decisions, time, provenance, replay behavior, candidate determinism, future-data isolation, and strategy identity.

Failure blocks strategy expansion.
