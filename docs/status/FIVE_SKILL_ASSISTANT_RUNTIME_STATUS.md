...
architecture/design and `docs/status/SKILL_OPTIMIZATION_STATUS.md` /
`docs/specs/ENTRY_CONFIRMATION_V1_SPEC.md` / `docs/specs/TRADE_MANAGEMENT_V1_SPEC.md` for prior-phase context.
...
| `docs/architecture/TRADE_ASSISTANT_ARCHITECTURE.md` | UPDATED | New "Generic Trade Assistant runtime" section; test count refreshed |
...
| `docs/specs/FIVE_SKILL_ASSISTANT_RUNTIME_V1_SPEC.md` | NEW | Full contract |
