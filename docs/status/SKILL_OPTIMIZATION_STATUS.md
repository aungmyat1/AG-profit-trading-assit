...
strategy ownership at face value. Full taxonomy: `docs/architecture/TRADE_ASSISTANT_ARCHITECTURE.md`'s
...
`Session Trade Codex`. Per `docs/architecture/ARCHITECTURE_CONFLICT_AUDIT.md`, both pairs coexist
