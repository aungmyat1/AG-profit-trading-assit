...
- Large-SMC contract resolution (`ST_LARGE_SMC_V1`, still `RESEARCH_DRAFT`):
  ...
  and [`status/ST_LARGE_SMC_V1_C14_DUPLICATE_REENTRY_CONTRACT_RESOLUTION_STATUS.md`](status/ST_LARGE_SMC_V1_C14_DUPLICATE_REENTRY_CONTRACT_RESOLUTION_STATUS.md)
