...
| BTC observation contract | A | EDGE_VALIDATION | IMPLEMENTED | FOCUSED_VERIFIED | NOT_APPLICABLE | NOT_REQUIRED | READY | `docs/contracts/AG_BTC_DAILY_OBSERVATION_CONTRACT_V1.md` — UTC half-open day, 06:30-06:45 UTC report target (13:00-13:15 MMT), no strategy timing conflict found | none | maintain |
| BTC scheduler readiness | B (supports A) | OPERATIONAL_SUPPORT | IMPLEMENTED (installer template) | UNVERIFIED (not installed/running) | N/A | NOT_STARTED | READY | `scripts/install_btc_daily_task.ps1` default 13:05 MMT | installation remains unauthorized | manual report or separate authorization |
