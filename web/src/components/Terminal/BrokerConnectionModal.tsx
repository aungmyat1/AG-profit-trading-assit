...
export const BrokerConnectionModal: React.FC<BrokerConnectionModalProps> = ({
  ...
  const [accountName, setAccountName] = useState<string>('Vantage Demo #0 (FX & Crypto CFD)');
  ...
  const handleResetDefaults = () => {
    ...
    setAccountName('Vantage Demo #0 (FX & Crypto CFD)');
              ...
              <div className="bg-slate-950/70 rounded-xl border border-slate-800 p-4 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-emerald-400 font-mono mt-1 block">Active account for both FX & Crypto CFD (VANTAGE-DEMO-LOGIN=0)</span>
                  </div>
