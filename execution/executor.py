...
Python-level invariant, deliberately not a config toggle (see TRADE_ASSISTANT_ARCHITECTURE.md
...
# See TRADE_ASSISTANT_ARCHITECTURE.md "Execution authority restructure" design notes.
